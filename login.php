...
{
$_SESSION['user']=$e;
header('location:http://localhost/onlinefeedback/user/index.php');
}
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input name="save" type="submit" value="Login" class="btn btn-lg btn-info btn-block" style="opacity: 0.7;">
                                </div>
                            </fieldset>
                        </form>
                    </div>
