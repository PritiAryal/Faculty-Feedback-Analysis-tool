...
?>
     ...
     <!--    <div class="row">
        ...
        <!-- Content Row -->
       <div class="row">
            <div class="col-md-8 breadcrumb"style="margin-top: 1vh;">
                <h3>Contact us </font></h3>
            ...
            <div class="col-md-4">
                <h4 align="left" style="margin-top: 1vh;text-align: center;">CONTACT DETAILS</h4>
            <div class="polaroid">
              <img src="images/feedback11.jpg" alt="Norway" style="width:100%;">
                    <p>Nepal<br>Kathmandu<br></p>
        <hr>

                <p  style="text-align: left; padding-left: 6vw;"><i class="fa fa-phone"></i> <abbr title="Phone">P</abbr>: (123) 456-7890</p>
                <p  style="text-align: left; padding-left: 6vw;"><i class="fa fa-envelope-o"></i> <abbr title="Email">E</abbr>: <a href="mailto:name@example.com" style="color: black">info@facultyfeedback.com</a></p>
                <p  style="text-align: left; padding-left: 6vw;"><i class="fa fa-clock-o"></i><abbr title="Hours">H</ab6br>: Monday - Sunday <br>    9:00 AM to 9:00 PM</p>
                <ul class="list-unstyled list-inline list-social-icons"  style="text-align: left; padding-left: 6vw;">
